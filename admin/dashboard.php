...
<body class="bg-gray-100">
    <div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <!-- Statistics Cards -->
            <div class="grid grid-cols-1 mt-5 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-5">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
            ...
            <div class="mt-8">
                ...
                <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    <a href="manage-pets.php" class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <svg class="h-6 w-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-2 flex-shrink-0 flex">
                                                <p class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                    <?php echo $application['status'] === 'pending' ? 'bg-yellow-100 text-yellow-800' : ($application['status'] === 'approved' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
